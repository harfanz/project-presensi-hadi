                        ...
                        <div class="row">
                            <div class="col-10">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nama_dept" id="nama_dept" placeholder="Departemen" value="{{ Request('nama_dept') }}">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <span class="input-icon-addon">
                                ...
                                <input type="text" value="" class="form-control" id="kode_dept" name="kode_dept" placeholder="Nama Dept">
                    </div>        
                </div>
            </div>
            <div class="row">
